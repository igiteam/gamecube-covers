#!/usr/bin/env python3
"""
gamecube_games_dolphin Games Grid Generator
Creates an Xemu-style grid website from your gamecube_games_dolphin games JSON
...
# Configuration
JSON_FILE = "gamecube_games_dolphin.json"
OUTPUT_HTML = "gamecube_games_dolphin.html"
PLACEHOLDER_IMAGE = "https://raw.githubusercontent.com/igiteam/gamecube-covers/refs/heads/master/gamecube-cover-default.png"
RAW_BASE_URL = "https://raw.githubusercontent.com/igiteam/gamecube-covers/tree/master/Named_Boxarts"
...
<body>
  <div id="saved-search-container">
    <div class="search-row">
      ...
      <a href="https://cdn.sdappnet.cloud/rtx/gamecube_magazine.html" target="_blank">
...
"""
    ...
    for game in games:
        ...
        <div class="col px-1 mb-4 title-card" data-title-name="{title}" data-title-status="Play">
          <a target="_blank" rel="norefferer" href="https://github.com/igiteam/gamecube-covers">
